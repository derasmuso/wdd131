...
const temples = [
    ...
    },
    {
        ...
        area: 16350,
        imageUrl:
            "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/helsinki-finland/400x250/helsinki-finland-temple-lds-354503-wallpaper.jpg"
    }
];

createTempleCard(temples);

const homeTemples = document.querySelector("#all-temples");
...
function createTempleCard(filteredTemples) {
    ...
    filteredTemples.forEach(temple => {
        ...
        area.innerHTML = `<span class="label">Size:</span> ${temple.area} sq fr`;
